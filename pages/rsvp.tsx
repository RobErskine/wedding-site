      ...
      <div>
        ...
        <div className="mb-4">
          ...
          <select
            ...
            defaultValue="Yes, can&apos;t wait! I&apos;ll be there."
          >
            <option>Yes, can&apos;t wait! I&apos;ll be there.</option>
            <option>Sounds fun, but I need a little time to figure out logistics.</option>
